...
public class Grawitacja extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grawitacja);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.navigation_home:
                        Intent i = new Intent(Grawitacja.this, StronaGlowna.class);
                        i.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        i.putExtra("miejsce", "Grawitacja");
                        i.putExtra("nick", nick);
                        i.putExtra("imageUrl", imageUr);
                        startActivity(i);
                        break;
                    case R.id.navigation_school:
                        Intent i1 = new Intent(Grawitacja.this, Szkola.class);
                    ...
                    case R.id.navigation_favourite:
                        Intent i2 = new Intent(Grawitacja.this, Czat.class);
                        i2.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        i2.putExtra("miejsce", "Grawitacja");
                        i2.putExtra("nick", nick);
                        i2.putExtra("imageUrl", imageUr);
                        startActivity(i2);
                        break;
                    case R.id.navigation_account:
                        Intent i3 = new Intent(Grawitacja.this, Konto.class);
                        i3.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        i3.putExtra("miejsce", "Grawitacja");
                        i3.putExtra("nick", nick);
                        i3.putExtra("imageUrl", imageUr);
                        startActivity(i3);
                        break;
                    case R.id.navigation_settings:
                        Intent i4 = new Intent(Grawitacja.this, Forum.class);
                        i4.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        i4.putExtra("miejsce", "Grawitacja");
        ...
        final Button przyspieszenie = findViewById(R.id.przyszpieszenie2);
        przyspieszenie.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Grawitacja.this, Przyszpieszenie.class);
                i.putExtra("nick", nick);
                i.putExtra("imageUrl", imageUr);
                startActivity(i);
                Animatoo.animateFade(Grawitacja.this);
            }
        });
        final Button ruch = findViewById(R.id.ruchPoOkregu);
        ruch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Grawitacja.this, RuchPoOkregu.class);
                i.putExtra("nick", nick);
                i.putExtra("imageUrl", imageUr);
                startActivity(i);
                Animatoo.animateFade(Grawitacja.this);
        ...
        Button keppler = findViewById(R.id.keppler);
        keppler.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Grawitacja.this, Keppler.class);
                i.putExtra("nick", nick);
                i.putExtra("imageUrl", imageUr);
                startActivity(i);
                Animatoo.animateFade(Grawitacja.this);
        ...
        Button modelBohra = findViewById(R.id.modelBohra);
        modelBohra.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Grawitacja.this, ModelBohra.class);
                i.putExtra("nick", nick);
                i.putExtra("imageUrl", imageUr);
                startActivity(i);
                Animatoo.animateFade(Grawitacja.this);
        ...
        mdrawerLayout = findViewById(R.id.drawerGrawitacja_layout);
        ...
        listHeaderView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                Intent i = new Intent(Grawitacja.this, Konto.class);
                startActivity(i);
                Animatoo.animateFade(Grawitacja.this);
                return false;
            }
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                if(selectedItem.equals("Czworokąty")){
                    Intent i = new Intent(Grawitacja.this, Szkola.class);
                    startActivity(i);
                    Animatoo.animateFade(Grawitacja.this);
                }
    ...
    public void onBackPressed() {
        if(mdrawerLayout.isDrawerOpen(GravityCompat.START)){
            ...
            Intent i = new Intent(Grawitacja.this, FizykaKalkulator.class);
            startActivity(i);
            Animatoo.animateFade(Grawitacja.this);
        }
    }
